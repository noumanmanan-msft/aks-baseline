...
# 03 - Prep for Azure Active Directory integration
...
# 05 - Prep for cluster bootstrapping
...
# 07 - Validate your cluster is bootstrapped and enrolled in GitOps
...
# 09 - Configure AKS ingress controller with Azure Key Vault integration
